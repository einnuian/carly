...
//   // Keep stepIndex in bounds when driveDaily changes to "yes"
//   useEffect(() => {
...
//         <div className="quiz-logo">Carly</div>
//         <div className="quiz-nav-right">Car Finder Quiz</div>
//       </header> */}
//       <NavBar />
...
//             {/* Extra input for tripsPerWeek "Other" */}
//             {currentStep.id === "tripsPerWeek" && (
